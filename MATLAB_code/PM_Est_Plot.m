...
close all
% load('No_cal_pm_est_all.mat')
load('Angled_Cal_pm_est_all.mat')
load('pm_true_all.mat')

figure(1)
%plotting data
plot(pm_true_all(2,:)*1e3,pm_true_all(1,:)*1e3,'bo', 'MarkerSize', 8, LineWidth=1)
hold on
plot(pm_est_all(2,:)*1e3,pm_est_all(1,:)*1e3,'rx', 'MarkerSize', 10, LineWidth=1)

fontsize(figure(1),14,"points")
xticks(-80:20:80)
yticks(-30:10:30)
xlabel('x [mm]')
ylabel('y [mm]')
legend({'True Position', 'Estimated Position'}, "Location",'southwest', 'FontSize',10)
% title('Top View')
hold on
...
set(figure(1), 'Position',  [100, 100, 800, 640])
...
plot(11, 10.5, 'rx', 'MarkerFaceColor', [1 0.07 0.07], 'MarkerSize', 12, LineWidth=1.5)
