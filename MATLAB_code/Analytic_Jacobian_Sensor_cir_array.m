function [J] = Analytic_Jacobian_Sensor_cir_array(pm0,xyz_s,meas_dir_s,M)
...
% output:
%        J : Jacobian w.r.t Sx,Sy,Sz,m  <- R^(3N x 4)
...
dB_mi_dm = reshape(meas_dir_s'*[dB_ix_dm;dB_iy_dm;dB_iz_dm],[N_d*N,1]);

J = [ dB_mi_dx  dB_mi_dy  dB_mi_dz dB_mi_dm];
